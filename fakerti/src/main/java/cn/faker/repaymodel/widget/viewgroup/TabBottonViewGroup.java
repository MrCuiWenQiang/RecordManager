...
public class TabBottonViewGroup extends LinearLayout {
    ...
    public TabBottonViewGroup(Context context) {
        super(context);
    }

    public TabBottonViewGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TabBottonViewGroup(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public static class TabItemView extends LinearLayout {
        ...
        //选中状态下文字颜色变化 默认黑色
        private int textResPress = R.color.RoundFillColor;
         ...
         * @param textResPress 选中状态下的标题颜色
         */
        public TabItemView setTxtRes(int textResPress) {
            this.textResPress = textResPress;
            return this;
        }
         ...
         * @param textResPress 选中状态下的标题颜色
         */
        public TabItemView setTxtRes(int textResDef, int textResPress) {
            this.textResDef = textResDef;
            this.textResPress = textResPress;
            return this;
        }
